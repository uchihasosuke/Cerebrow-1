<img src="./assets/web-ui.png" alt="Cerebrow Web UI" width="full"/>
...
```bash
git clone https://github.com/inventy2025/cerebrow.git
cd cerebrow
```
...
## Changelog
- [x] **2025/01/26:** Thanks to @vvincent1234. Now Cerebrow can combine with DeepSeek-r1 to engage in deep thinking!
